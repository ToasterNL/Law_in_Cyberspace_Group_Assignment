...
\subsubsection{\ePD 2002/58/EC \cite{ePD}} 
...
\subsubsection{\DPD 95/46/EC \cite{DPD}}
\label{DPD}
\begin{itemize}
...
\noindent Other advice that should be given to the court: 
\begin{itemize}
	\item The courts should look at how the information is question was collected, especially if the consent of the user was asked or not. It should be taken into account that most users have no idea that they are being tracked and that most people skip reading of the
